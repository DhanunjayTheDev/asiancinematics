...
import footerLogo from "../assets/pravaraworldmainlogo.png";
  ...
  <footer className="bg-black border-t border-blue-500/20">
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-1">
          ...
          <p className="text-xs text-gray-400 leading-relaxed mb-4">
            Premier smart technology & lifestyle solutions Home Theatre, Smart
            Home, Security, Decoratives, and Structural Works. PAN India
            service.
          </p>
          <div className="flex gap-4">
            <a
              href="#"
              className="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 hover:bg-blue-500/30 transition-colors"
            >
        ...
        <div>
          ...
          <ul className="space-y-3 text-xs text-gray-400">
            ...
            <li>
              <a
                href="mailto:info@pravaraworldtech.com"
                className="hover:text-yellow-400 transition-colors flex items-center gap-2"
              >
      ...
      <div className="py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
        <p>
          &copy; {new Date().getFullYear()} Pravara World Tech. All rights
          reserved.
        </p>
