...
const SmartHomeServiceRequestModal = ({ isOpen, onClose }: Props) => {
  ...
  const buildWhatsAppMessage = () => {
    return `🏡 Smart Home Automation Service Request:
Name: ${form.name}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur p-4">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700 sticky top-0 bg-gray-900 z-10">
          <div>
            <h2 className="text-xl font-bold text-white">🏡 Smart Home Automation Service Request</h2>
        ...
        <div className="px-6 py-5">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-cyan-500"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-cyan-500 resize-none"
                  placeholder="Full address"
                />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">Automation System Type</label>
                <select
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-cyan-500 resize-none"
                  placeholder="Describe your smart home requirements..."
                />
              </div>
              ...
              {form.serviceRequestType && (
                <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-4">
                  <p className="text-cyan-400 font-semibold">Service Charge: ₹{form.serviceAmount}</p>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full bg-cyan-500 hover:bg-cyan-600 disabled:opacity-60 text-black font-bold py-3 rounded-xl transition"
              >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white font-mono focus:outline-none focus:border-cyan-500"
              ...
              <div>
                ...
                {screenshotPreview ? (
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-3 border-2 border-dashed border-gray-600 rounded-xl text-gray-400 hover:border-cyan-500 hover:text-cyan-400 transition w-full justify-center"
                  >
          ...
          {step === 'success' && (
            <div className="text-center py-8 space-y-4">
              <FiCheckCircle className="w-16 h-16 text-cyan-400 mx-auto" />
              <h3 className="text-2xl font-bold text-white">Payment Submitted!</h3>
              <p className="text-gray-300 max-w-sm mx-auto">
                Our team will verify your payment and confirm your smart home service request soon.
              </p>
              <p className="text-sm text-gray-400">We'll contact you at <span className="text-white font-medium">{form.contact}</span></p>
              <button
                onClick={handleClose}
                className="mt-4 px-8 py-3 bg-cyan-500 hover:bg-cyan-600 text-black font-bold rounded-xl transition"
              >
                Done
              </button>
            </div>
...
export default SmartHomeServiceRequestModal;
