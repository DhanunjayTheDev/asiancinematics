...
import { FiSearch, FiFilter, FiArrowRight, FiPhone, FiCheck, FiTrendingUp, FiAward, FiShoppingCart, FiTruck, FiLock, FiSun, FiStar } from 'react-icons/fi';
...
const ProductsPage = () => {
  ...
  const productFeatures = [
    { title: 'Free Expert Advice', icon: <FiSun className="w-6 h-6" /> },
    { title: 'Fast Delivery', icon: <FiTruck className="w-6 h-6" /> },
    { title: 'Secure Payment', icon: <FiLock className="w-6 h-6" /> },
    { title: 'Easy Returns', icon: <FiArrowRight className="w-6 h-6" /> },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {productFeatures.map((feature, idx) => (
                <div key={idx} className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-blue-500/20 rounded-xl p-6 hover:shadow-xl hover:shadow-blue-500/10 transition-all">
                  ...
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {products.map((product) => (
                        <div key={product._id} className="product-card-animate">
        ...
        <div className="bg-gradient-to-t from-blue-950/30 to-transparent py-16 border-t border-blue-500/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Contact our sales team for special pricing and personalized solutions
            </p>
